...
mongoose.connect('mongodb://mongoRoot:Almi123@localhost/NetAlmix?authSource=admin', { useNewUrlParser: true, useUnifiedTopology: true });
...
app.get('/', (req, res) => res.send('Servicio Web NetAlmix'));
